...
@if ($sliderItem -> discount == 1)<span class="discount_date">{{$sliderItem -> discount_date}}</span>

@endif

@if ($sliderItem -> discount == 0) <span class="discount_none"></span> @endif
                                            <div class="row justify-content-center ">
                             ...
                             <div class="row justify-content-center " >
                                            ...
                                            <p><a class="main-goods__title" style="white-space: normal;" href="/product/{{$sliderItem -> id}}">
                                                {{$sliderItem -> name_site}}

                                            </a></p>

                                                            <div class="But_add" ><div class="row justify-content-center " >
<div class="row justify-content-center " >
@if ($sliderItem -> discount)
<div class="g-price-old-uah_s">
            {{$sliderItem ->last_price}}<span class="g-price-old-uah-sign"> грн</span>
                                </div>
@endif
        ...
        @foreach ($latestProducts as $product)
            <div class="col-4">
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
@if ($product ->discount == 1) <span class="discount_date">{{$product ->discount_date}}</span> @endif
@if ($product ->discount == 0) <span class="discount_none"></span> @endif
